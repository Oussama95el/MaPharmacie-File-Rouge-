          ...
          <form @submit.prevent="submitData" method="POST">
            <div class="shadow overflow-hidden sm:rounded-md">
                ...
                <div class="grid grid-cols-6 gap-6">
                  ...
                  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                    ...
                    <input
                      ...
                      type="number"
                      step="0.01"
                      v-model="defaultForm.prix_achat"
                      name="buying_price"
                      id="buying_price"
                      class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                    />
                  ...
                  <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                    ...
                    <input
                      ...
                      type="number"
                      step="0.01"
                      v-model="defaultForm.prix_vente"
                      name="selling_price"
                      id="selling_price"
                      class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                    />
              ...
              >
                <button
                  type="submit"
                  class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-primary hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                  Submit
                </button>
                <button
                  ...
                  type="submit"
                  class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-gray-400 hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                  Cancel
                </button>
              </div>
...
const endpointUpdate =
  "http://localhost/MaPharmacie/backend/public/product/update";
...
export default {
  ...
  methods: {
    submitData() {
      ...
      axios.post(endpoint, this.defaultForm).then((res) => {
        if (res.status === 200) {
          swal({
            title: "Good job!",
            text: isUpdate
